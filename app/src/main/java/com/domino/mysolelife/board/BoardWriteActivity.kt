...
import com.domino.mysolelife.contentsList.BookmarkModel
import com.domino.mysolelife.databinding.ActivityBoardWriteBinding
...
class BoardWriteActivity : AppCompatActivity() {
    ...
    private var isImageURpload = false
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.writeBtn.setOnClickListener {
            ...
            // 이미지 이름 정보를 모르기 때문에
            // 이미지 이름을 문서의 key값으로 설정하고 이미지 정보를 찾기 쉽게 해놓는다
            ...
            if(isImageURpload==true){
                imageUpload(key) // 이미지를 db에 업로드
            }
